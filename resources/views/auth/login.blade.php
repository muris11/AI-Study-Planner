                ...
                <div class="space-y-8 animate-slide-up">
                    <div>
                        ...
                        <p class="text-lg md:text-xl text-white/90 mt-6 leading-relaxed drop-shadow-md">
                            Masuk ke akun Anda untuk melanjutkan perjalanan belajar yang dipersonalisasi dengan bantuan
                            kecerdasan buatan.
                        </p>
                    </div>
                    ...
                    <div class="floating">
                        <div
                            ...
                            <div class="text-center mb-6">
                                ...
                                <p class="text-blue-100">Lanjutkan perjalanan belajar Anda</p>
                            </div>
                           ...
                           <!-- AI Optimization Visualization -->
                            <div class="mt-6 p-4 bg-white/10 backdrop-blur-sm rounded-lg">
                                <div class="flex items-center mb-2">
                                    ...
                                    <span class="text-sm font-medium">AI siap membantu perjalanan belajarmu</span>
                                </div>
                                ...
                                <p class="text-xs text-blue-100 mt-2">
                                    AI akan menyesuaikan jadwal, prioritas, dan pengingat belajar sesuai kebutuhanmu.
                                </p>
                            </div>
                        </div>
                    </div>
